...
class A7_03{
    public static void main(String args[]){
	    ...
	    h5set.add(new Employee(1,"Jai"));
     	h5set.add(new Employee(2,"Mahesh"));
    	h5set.add(new Employee(3,"Vishal"));
	    h5set.add(new Employee(3,"Vishal"));//duplicate element
	    System.out.println("\nremoving user defined duplicate element:\n"+h5set);
	    
	    //Find user defined objects from HashSet   && also delete the user defined object....h5set
	    Employee emp=new Employee(2,"Mahesh");
	    System.out.println("Does it contain the object : "+h5set.contains(emp)); //finding
	     
	    h5set.remove(emp);                                 //deleting
	    System.out.println("\nObject deleted....");
